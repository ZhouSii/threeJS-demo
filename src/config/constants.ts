...
import imageEarthAperture from '@/assets/images/earth_aperture.png'
import imageEarth1 from '@/assets/images/earth2.jpg'


export const PAGE_WIDTH = 375
export const PAGE_HEIGHT = 600
// export const PAGE_WIDTH = window.document.body.clientWidth
// export const PAGE_HEIGHT = window.document.body.clientHeight
...
export const IMAGE_URLS = {
    ...
    earthAperture: imageEarthAperture,
    imageEarth1: imageEarth1,
    cloud0,
    cloud1,
    cloud2,
    cloud3,
